...
class FCTreeSheet(object):
	...
	def get_branches(self,face_up_from,map,couples,bb={}):
		next_calls=[]
		#branches=[]
		#bb={}
		face_down=None
		...
		for n in next_calls:
			...
			bb.update(self.get_branches(n,map,c,bb))
		return bb
